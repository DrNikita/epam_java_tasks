...
public class DiamondTreasures implements Treasure {
	private TreasuresType treasuresType;
	private double weight;
	private double factor;
	private String material = "Diamond";

	public DiamondTreasures(double weight, TreasuresType treasuresType) {
		this.factor = 1000000;
		this.weight = weight;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DiamondTreasures other = (DiamondTreasures) obj;
	...
	public String toString() {
		return "DiamondTreasures [treasuresType=" + treasuresType + ", weight=" + weight + ", factor=" + factor
				+ ", material=" + material + "]";
	}
}
