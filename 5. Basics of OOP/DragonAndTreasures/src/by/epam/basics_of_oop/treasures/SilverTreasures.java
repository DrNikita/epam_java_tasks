...
public class SilverTreasures implements Treasure {
	private TreasuresType treasuresType;
	private double weight;
	private double factor;
	private String material = "Silver";

	public SilverTreasures(double weight, TreasuresType treasuresType) {
		this.factor = 753;
		this.weight = weight;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SilverTreasures other = (SilverTreasures) obj;
	...
	public String toString() {
		return "SilverTreasures [treasuresType=" + treasuresType + ", weight=" + weight + ", factor=" + factor
				+ ", material=" + material + "]";
	}
}
