...
public class Berth1 extends StartBerth implements Runnable {
	private static boolean isEmpty = true;

	public Berth1(ProgenitorShip ship, String function) {
		super(ship, function);

		if (this.isEmpty == true) {
			this.isEmpty = false;
		} else {
			System.out.println("The 1st berth is busy");
		}
	}
