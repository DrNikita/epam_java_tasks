...
public class Berth3 extends StartBerth implements Runnable {
	private static boolean isEmpty = true;

	public Berth3(ProgenitorShip ship, String function) {
		super(ship, function);

		if (this.isEmpty == true) {
			this.isEmpty = false;
		} else {
			System.out.println("The 3rd berth is busy");
		}
	}
