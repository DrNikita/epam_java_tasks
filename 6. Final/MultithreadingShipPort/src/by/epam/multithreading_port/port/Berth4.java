...
public class Berth4 extends StartBerth implements Runnable {
	private static boolean isEmpty = true;

	public Berth4(ProgenitorShip ship, String function) {
		super(ship, function);
		
		if (this.isEmpty == true) {
			this.isEmpty = false;
		} else {
			System.out.println("The 4th berth is busy");
		}
	}
